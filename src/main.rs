...
fn main() {
    ...
    let sphere = Object {
        hittable: Hittable::Sphere(Sphere::new(Vec3::new(0.0, 0.1, -1.0), 0.5).unwrap()),
        material: Material::Metal(Metal::new(Color::new(1.0, 0.6, 0.6).unwrap())),
    };
    let ground = Object {
        hittable: Hittable::Sphere(Sphere::new(Vec3::new(0.0, -100.5, -1.0), 100.0).unwrap()),
        material: Material::Lambertian(Lambertian::new(Color::new(0.5, 0.5, 0.5).unwrap())),
    };
